...
// /**
//  * Map frontend select values -> Django ChannelPartnerType enum
//  *
//  * ChannelPartnerType:
//  *  BROKER, CONSULTANT, AGENCY, FREELANCE_AGENT, CHANNEL_SALES_PARTNER
//  */
// const PARTNER_TYPE_MAP = {
//   independent: "BROKER", // "Independent Broker" -> BROKER
//   agency: "AGENCY", // "Agency" -> AGENCY
//   online: "CHANNEL_SALES_PARTNER", // map "Online Portal" -> CHANNEL_SALES_PARTNER
//   other: "CONSULTANT", // "Other" -> CONSULTANT (you can change this)
// };
...
//     // ---- property_categories -> ChannelPartnerProfile.property_categories (JSON list of enums) ----
...
//     // ---- marketing_strength -> ChannelPartnerProfile.marketing_strength (JSON list of enums) ----
...
//     // ---- partner_type -> ChannelPartnerType enum ----
//     const backendPartnerType = PARTNER_TYPE_MAP[form.partnerType] || "";

//     // ---- BULK PAYLOAD (list with ONE item) ----
//     // matches ChannelPartnerRegistrationSerializer(user, partner)
//     const payload = [
//       {
//         user: {
//           // required by your error: username + password
//           username: form.email || form.mobile,
//           password: form.mobile || "cp-temp-1234", // tweak as you like

//           // optional extra fields if serializer allows
//           full_name: form.contactName,
//           email: form.email,
//           mobile_number: form.mobile,
//           alternate_mobile_number: form.altMobile,
//         },
//         partner: {
//           // ChannelPartner fields (required ones per error)
...
//           // ChannelPartnerProfile-ish fields (depending on serializer)
//           rera_registration_number: form.reraNumber,
//           years_experience: form.experienceYears || null,
//           number_of_agents: form.teamAgents || null,
//           business_address: form.businessAddress,
//           areas_of_operation: form.operationAreas,

//           property_categories: propertyCategories, // ["RESIDENTIAL", ...]

//           // if you later add preferred_payment_mode, send it here

//           average_monthly_closures: form.avgClosures || null,
...
//           // in bulk JSON we can’t send actual files – just names if serializer supports it
//           rera_certificate_name: form.reraCert?.name || "",
//           business_license_proof_name: form.licenseProof?.name || "",

//           terms_accepted: form.termsAccepted,

//           marketing_strength: marketingStrengths, // ["DIGITAL_MARKETING", ...]
...
//         "/channel/partners/bulk-register/",
//         payload // JSON list
//       );
...
//       }));
//     } catch (err) {
//       console.error("Bulk CP register failed", err);
...
//         msg = JSON.stringify(first.errors);
//       }
...
//                 </div>
//                 <div className="cp-field">
//                   <label>Upload RERA Certificate</label>
//                   <input
//                     className="cp-input"
//                     type="file"
...
//                 </div>
//                 <div className="cp-field">
//                   <label>Upload Business License / ID Proof</label>
//                   <input
//                     className="cp-input"
//                     type="file"
...
/** Helper to resolve active project id (same pattern as other screens) */
...
const ChannelPartnerRegistration = () => {
  ...
  // ---------------- Fetch sources & sub-sources ----------------
  useEffect(() => {
    const projectId = getActiveProjectId();
    if (!projectId) {
      // optional: warn in console only
      console.warn("No ACTIVE_PROJECT_ID / project_id found for LeadSource.");
      return;
    }
...
const handleSubmit = async (e) => {
  ...
  const payload = [
    {
      user: {
        ...
        last_name: lastName,
        // admin: <id>  // only if you need to set owner admin
      },
  ...
  try {
    ...
    if (typeof setSubSources === "function") {
      setSubSources([]);
    }
  } catch (err) {
